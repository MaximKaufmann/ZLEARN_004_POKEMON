CLASS zlearn_004_feuer_pokemon DEFINITION
  PUBLIC
  INHERITING FROM zlearn_004_basic_pokemon
  CREATE PUBLIC .
  PUBLIC SECTION.
    METHODS:
      glut IMPORTING chosen_pokemon TYPE REF TO zlearn_004_basic_pokemon.
...
CLASS zlearn_004_feuer_pokemon IMPLEMENTATION.
  ...
  METHOD glut.
    ...
    lv_result = 1 + me->lv_attack - chosen_pokemon->lv_defense.
    ...
    """"""""""""""""""Ausgabe der Werte""""""""""""""""""""""""""""
    WRITE:
    me->lv_name, 'greift', chosen_pokemon->lv_name, 'mit Glut an!',/.
