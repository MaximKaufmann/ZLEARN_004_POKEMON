class ZCL_ZLEARN_004_PK_ODAT_DPC definition
  public
...
protected section.
  ...
  methods POKEMONSET_CREATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type ZCL_ZLEARN_004_PK_ODAT_MPC=>TS_POKEMON
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods POKEMONSET_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods POKEMONSET_GET_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods POKEMONSET_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZLEARN_004_PK_ODAT_MPC=>TT_POKEMON
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods POKEMONSET_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
CLASS ZCL_ZLEARN_004_PK_ODAT_DPC IMPLEMENTATION.
...
*&* This class has been generated on 22.03.2023 10:06:25 in client 500
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZLEARN_004_PK_ODAT_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA pokemonset_create_entity TYPE zcl_zlearn_004_pk_odat_mpc=>ts_pokemon.
...
*     Call the entity set generated method
    pokemonset_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = pokemonset_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = pokemonset_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA pokemonset_get_entity TYPE zcl_zlearn_004_pk_odat_mpc=>ts_pokemon.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          pokemonset_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = pokemonset_get_entity
                         es_response_context = es_response_context
          ).

        IF pokemonset_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = pokemonset_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZLEARN_004_PK_ODAT_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA pokemonset_get_entityset TYPE zcl_zlearn_004_pk_odat_mpc=>tt_pokemon.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      pokemonset_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = pokemonset_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = pokemonset_get_entityset
        CHANGING
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA pokemonset_update_entity TYPE zcl_zlearn_004_pk_odat_mpc=>ts_pokemon.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          pokemonset_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = pokemonset_update_entity
          ).
       IF pokemonset_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = pokemonset_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    ...
    DATA(lv_sadl_xml) =
               ...
               | <sadl:dataSource type="DDIC" name="PokemonSet" binding="ZLEARN_004_PK_DB" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="PokemonSet" dataSource="PokemonSet" maxEditMode="RO" >| &
               ...
               | <sadl:attribute name="ELEMENT" binding="ELEMENT" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="HP" binding="HP" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="ATTACK" binding="ATTACK" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="DEFENSE" binding="DEFENSE" isOutput="TRUE" isKey="FALSE" />| &
               |</sadl:structure>| &
               |</sadl:resultSet>| &
               |</sadl:definition>| .
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20230322090630
               iv_uuid              = 'ZLEARN_004_PK_ODATA'
               io_query_control     = me
...
RETURN.
  ...
  method POKEMONSET_CREATE_ENTITY.
  ...
  method POKEMONSET_UPDATE_ENTITY.
